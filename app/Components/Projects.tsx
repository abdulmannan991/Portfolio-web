...
export default function Projects(){
    ...
    return(
        ...
        <div>
<h1 id="Skills" className=" mb-4 mt-10 text-white font-serif -tracking-tight text-2xl font-bold   md:text-4xl    w-auto flex justify-center">
   Projects
</h1>    
</div>
<div className="lg:space-x-40 flex flex-wrap justify-center  mt-10 ">

<div className="sm:flex sm:justify-start bg-gray-800  border-gray-800  justify-center w-64 rounded-lg mb-6 p-4 flex flex-col  ml-8 hover:border-teal-300 border-2 transition-all hover:scale-110 duration-300">
...
A fully responsive job portal website with a modern frontend using Tailwind CSS, a scalable backend with Next.js , and a secure database MySQL. Designed for seamless performance on all devices.
  ...
  <div className="flex justify-center mt-6 ml-2 sm:mr-6">
  <button onClick={Jobportal}  className="px-6 py-2 bg-gray-800 text-white font-semibold rounded-md transition-transform duration-300 hover:bg-teal-300 hover:scale-105">
    Check Now
  </button>
</div>
...
<div className="sm:flex sm:justify-end bg-gray-800 border-gray-800 w-64 rounded-lg mb-6 p-4 flex flex-wrap  ml-8 hover:border-teal-300 border-2 transition-all hover:scale-110 duration-300">
