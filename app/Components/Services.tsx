...
<div className="sm:flex sm:justify-start bg-gray-800  justify-center w-64 rounded-lg mb-6 p-4 flex flex-col  ml-8 hover:bg-teal-300 transition-all hover:scale-110 duration-300">
...
<div className="sm:flex sm:justify-end bg-gray-800  w-64 rounded-lg mb-6 p-4 flex flex-wrap  ml-8 hover:bg-teal-300 transition-all hover:scale-110 duration-300">
<h1 className=" mb-4 text-white font-serif -tracking-tight text-xl font-bold   md:text-4xl    w-auto flex justify-center ">
   Web Developer
</h1>
...
<div className="sm:flex sm:justify-start bg-gray-800  w-64 rounded-lg mb-6 p-4 flex flex-wrap  ml-8 hover:bg-teal-300 transition-all hover:scale-110 duration-300">
<h1 className=" mb-4 text-white font-serif -tracking-tight text-xl font-bold   md:text-4xl    w-auto flex justify-center ">
   TypeScript
</h1>
<p className="text-xs text-white leading-relaxed">
