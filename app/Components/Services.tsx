...
<div className=" sm:flex sm:justify-start sm:w-72 sm:h-72   bg-gray-800  justify-center w-64 rounded-lg mb-6 p-4 flex flex-col  ml-8 hover:bg-teal-300 transition-all hover:scale-110 duration-300">
<h1 className="sm:flex sm:justify-start sm:w-64 mb-4 text-white font-serif -tracking-tight text-xl font-bold   md:text-4xl    w-auto flex justify-center ">
   Flutter
</h1>

<p className="sm:flex sm:justify-start sm:w-64  text-xs text-white leading-relaxed ">
...
<div className="sm:flex sm:justify-start sm:w-72 sm:h-74  sm:mt-32  bg-gray-800  w-64 rounded-lg mb-6 p-4 flex flex-wrap  ml-8 hover:bg-teal-300 transition-all hover:scale-110 duration-300">
<h1 className="sm:flex sm:justify-start sm:w-64 mb-4 text-white font-serif -tracking-tight text-xl font-bold   md:text-4xl    w-auto flex justify-center ">
   Web Developer
</h1>
...
<div className="sm:flex sm:justify-start sm:w-72 sm:h-72  bg-gray-800  w-64 rounded-lg mb-6 p-4 flex flex-wrap  ml-8 hover:bg-teal-300 transition-all hover:scale-110 duration-300">
<h1 className="sm:flex sm:justify-start sm:w-64 mb-4 text-white font-serif -tracking-tight text-xl font-bold   md:text-4xl    w-auto flex justify-center ">
   TypeScript
</h1>
<p className="sm:flex sm:justify-start sm:w-64 text-xs text-white leading-relaxed">
    TypeScript is a superset of JavaScript that adds static typing, enabling developers to catch errors early during development. With features like interfaces and generics, TypeScript enhances code maintainability and readability. It integrates seamlessly with existing JavaScript code and offers powerful tooling support, making it ideal for large-scale applications where robustness and scalability are crucial.
  </p>
</div>
