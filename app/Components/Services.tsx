...
<p className="text-xs text-white leading-relaxed md:text-sm  group-hover:text-black">
...
<div className="sm:flex  bg-gray-800 justify-center w-64 rounded-lg mb-6 p-4 flex flex-wrap  ml-8 hover:bg-teal-300 transition-all hover:scale-110 duration-700 group">
<h1 className=" mb-4 text-white  font-serif -tracking-tight text-xl font-bold   md:text-4xl    w-auto flex justify-center group-hover:text-black">
   Web Developer
</h1>
<p className=" text-xs text-white leading-relaxed md:text-sm  group-hover:text-black">
